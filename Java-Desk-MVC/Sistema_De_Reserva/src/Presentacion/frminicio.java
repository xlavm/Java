...
public class frminicio extends javax.swing.JFrame {
    public frminicio() {
        initComponents();
        this.setExtendedState(frminicio.MAXIMIZED_BOTH);//para que ocupe toda la pantalla maximize
        this.setTitle("Menú Principal - Sistema de Reserva de Habitaciones y Gestión de ventas"); //titulo formulario
    }
    ...
    private void initComponents() {
        ...
        escritorio.setBackground(new java.awt.Color(212, 208, 200));
    ...
    private void cutMenuItemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cutMenuItemActionPerformed
        frmHabitacion form =new frmHabitacion();//instanciamos el formulario a llamar
        /*el DMI tiene el menú y tiene el Desktop panel, es aquí en el desktop panel donde se abrirán los formularios
        que hayamos escogido abrir en nuestro menú. le he cambiado de nombre, ya no es desktop_panel sino escritorio
        */
        escritorio.add(form);//en el desktop panel de nuestro MDI agregamos el formulario que instanciamos
        form.toFront(); //le decimos que aparezca en frente
        form.setVisible(true);// le decimos que se haga visible
    }//GEN-LAST:event_cutMenuItemActionPerformed
    //llama al formulario producto
    ...
    //llama al formulario trabajador
    ...
    private void mnusalirMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_mnusalirMouseClicked
        //se cerrara cuando se haga clic en el menu salir. por eso está en el evento mouseClicked
        this.dispose();
    }//GEN-LAST:event_mnusalirMouseClicked
    //llama al formulario reserva y le lleva algunos datos 
